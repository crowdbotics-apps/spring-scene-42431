"""
Django settings for spring_scene_42431 project.
...
ROOT_URLCONF = 'spring_scene_42431.urls'
...
WSGI_APPLICATION = 'spring_scene_42431.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_scene_42431 API",
    "DESCRIPTION": "API documentation for spring_scene_42431 App",
    "VERSION": "v1",
}
